...
namespace Estafette.Ci.Manifest.V1 {
  ...
  /// <summary>Holder for reflection information generated from estafette/ci/manifest/v1/estafette_pipeline_event.proto</summary>
  public static partial class EstafettePipelineEventReflection {

    #region Descriptor
    /// <summary>File descriptor for estafette/ci/manifest/v1/estafette_pipeline_event.proto</summary>
    ...
    static EstafettePipelineEventReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cjdlc3RhZmV0dGUvY2kvbWFuaWZlc3QvdjEvZXN0YWZldHRlX3BpcGVsaW5l",
            "X2V2ZW50LnByb3RvEhhlc3RhZmV0dGUuY2kubWFuaWZlc3QudjEinwEKFkVz",
            "dGFmZXR0ZVBpcGVsaW5lRXZlbnQSFQoNYnVpbGRfdmVyc2lvbhgBIAEoCRIT",
            "CgtyZXBvX3NvdXJjZRgCIAEoCRISCgpyZXBvX293bmVyGAMgASgJEhEKCXJl",
            "cG9fbmFtZRgEIAEoCRITCgtyZXBvX2JyYW5jaBgFIAEoCRIOCgZzdGF0dXMY",
            "BiABKAkSDQoFZXZlbnQYByABKAlCeAocY29tLmVzdGFmZXR0ZS5jaS5tYW5p",
            "ZmVzdC52MVABWjtnaXRodWIuY29tL2VzdGFmZXR0ZS9lc3RhZmV0dGUtY2kt",
            "cHJvdG9zLWdvbGFuZy9tYW5pZmVzdF92MaoCGEVzdGFmZXR0ZS5DaS5NYW5p",
